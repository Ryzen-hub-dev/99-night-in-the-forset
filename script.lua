...
local Rayfield = loadstring(game:HttpGet('https://raw.githubusercontent.com/Ryzen-hub-dev/99-night-in-the-forset/refs/heads/main/main.lua'))()
...
local Window = Rayfield:CreateWindow({
    Name = "99 Nights",
    LoadingTitle = "Ryzen Hub : 99 Nights Script",
